...
mastermind:setParameter(CONDITION_PARAM_STAT_MAGICPOINTS, 10)
...
local potions = {
	...
	[7588] = {health = {425, 575}, vocations = {3, 4, 7, 8}, level = 50, flask = 7634,
			description = "Only knights and paladins level 50 or above may drink this potion."},
	-- strong mana potion
	[7589] = {mana = {325, 475}, vocations = {1, 2, 3, 5, 6, 7}, level = 50, flask = 7634,
			description = "Only sorcerers, druids and paladins level 50 or above may drink this potion."},
	-- great mana potion
	[7590] = {mana = {625, 750}, vocations = {1, 2, 5, 6}, level = 80, flask = 7635,
			description = "Only druids and sorcerers level 80 or above may drink this potion."},
	-- great health potion
	[7591] = {health = {750, 800}, vocations = {4, 8}, level = 80, flask = 7635,
			description = "Only knights level 80 or above may drink this potion."},
	-- health potion
	...
	[8472] = {health = {250, 350}, mana = {100, 200}, vocations = {3, 7}, level = 80, flask = 7635,
			description = "Only paladins level 80 or above may drink this potion."},
	-- ultimate health potion
	[8473] = {health = {1000, 1200}, vocations = {4, 8}, level = 130, flask = 7635,
			description = "Only knights level 130 or above may drink this potion."},
	-- antidote potion
	[8474] = {combat = antidote, flask = 7636},
	-- small health potion
	[8704] = {health = {60, 85}, flask = 7636},
	-- ultimate mana potion
	[26029] = {mana = {875, 1000}, vocations = {1, 2, 5, 6}, level = 130, flask = 7635,
			description = "Only druids and sorcerers of level 130 or above may drink this potion."},

	[26030] = {health = {400, 500}, mana = {250, 375}, vocations = {3, 7}, level = 130, flask = 7635,
			description = "Only paladins level 130 or above may drink this potion."},
	-- supreme health potion
	[26031] = {health = {1275, 1525}, vocations = {4, 8}, level = 200, flask = 7635,
			description = "Only knights level 200 or above may drink this potion."}
}
